...
export const Route = createFileRoute("/assignments")({
  head: () => ({
    meta: [
      { title: "Assignments — pycourse" },
      {
        name: "description",
        content: "All practice challenges and mini-projects across the 12 modules.",
      },
    ],
  }),
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10">
      ...
      <p className="mt-2 text-muted-foreground max-w-2xl">
        Every practice challenge across the twelve modules. Click through to attempt in the live
        editor.
      </p>
